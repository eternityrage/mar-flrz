...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "💬 Marcella Fiorenzina Daily!\n\n#marcellafiorenzina"
        ...
        video = upload.video(
            ...
            name=title or 'Marcella Fiorenzina Video',
...
def main():
    ...
    title = sys.argv[3] if len(sys.argv) > 3 else "Marcella Fiorenzina"
