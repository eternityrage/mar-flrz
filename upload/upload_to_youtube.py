...
def main():
    ...
    title = "Marcella Fiorenzina Daily"
    description = "#shorts #marcellafiorenzina"
    tags = ['fashion', 'beauty', 'lifestyle', 'travel', 'style', 'romantic', 'italian', 'photography', 'wellness', 'marcellafiorenzina', 'ootd', 'skincare', 'selfcare', 'inspiration', 'livebeautifully']
